...
% THE PHASE TABLE IS A CONTRACT: 5 / 34 / 8 / 8 — I do ~20 of the 34, Guided Practice ~14;
...
Debrief & 8 & Pens down, papers up --- answer aloud, nothing to fill in & TODO what goes back
...
\columnbreak
\textbf{We do (about 14 min).} The Guided Practice box, \emph{TODO title} --- the same moves the
...
debrief eat the last eight minutes.}
\end{multicols}
\end{skillbox}
...
TODO items, scored, due next class. Circulate: \textbf{item~TODO tells you whether section~2
...
\begin{teachernote}[Guided Notes \& Practice]
    % TODO: pace it 20 / 14, then 8 / 8; which move to take a vote on before anyone writes;
