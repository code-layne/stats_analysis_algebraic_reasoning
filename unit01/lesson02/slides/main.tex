...
% ── 2c. WHAT A SAMPLE LETS YOU SAY ───────────────────────────────────────────
\begin{frame}[t, plain]
  \ceruleanheader{What a sample lets you say --- and what it does not}
  \sectionlabel{notes section 2 $\cdot$ estimate, not count}
  \vspace{4pt}
  \begin{block}{The manager's sentence}
    ``Of the \textbf{50} shoppers we asked, \textbf{52\%} drove. If our sample represents the
    market, that is about \textbf{416} of the \textbf{800} shoppers who come on a Saturday.''
  \end{block}
  \vspace{8pt}
  \begin{columns}[t]
    \begin{column}{0.47\textwidth}
      \begin{block}{``Exactly 416 drove.''}
        \redink{Not allowed.} 416 is an estimate of the parameter --- nobody counted it.
      \end{block}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{block}{``52\% of Lakeside residents drive to the market.''}
        \redink{Not allowed.} Residents were never the population.
      \end{block}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \begin{enumerate}\setlength{\itemsep}{5pt}
    ...
    \item ``Exactly 416 drove.'' Which word is wrong, and why?
  \end{enumerate}
  \vspace{6pt}
...
\begin{frame}[t, plain]
  ...
  \end{itemize}
  \begin{block}{Silent and alone --- I am circulating. Packet pages, scored out of 12, due next class.}
