...
\begin{multicols}{2}
\textbf{I do (about 20 min).} Two sections, each in two moves; students fill the blanks as each idea is named, and the vocabulary box on page~1 is filled \emph{as you go}, never in advance. \textbf{Every fill-in cluster opens with a word bank}; the work is choosing and justifying, not recalling.
...
statistics, one parameter, nobody wrong. Land the sentence in the blue callout word by word: \emph{the statistic moves; the parameter stays put}. Six minutes. (The report sentence and the over-claim moved to Guided Practice part~(e) so section~2 fits its page.)

\columnbreak
\textbf{We do (about 15 min).} The Guided Practice box, \emph{The Riverbend Job Survey}, alone on page~4 --- the same moves the homework will ask alone, on a school instead of a market. \textbf{Students
...
\begin{itemize}[leftmargin=1.1em, nosep]
  ...
  \item \textbf{Part (c):} ``Which of the two surveys found the true percent?'' A student who picks one has not left the hook vote.
  \item \textbf{Part (e):} ``Who counted 360 students?'' Nobody --- it was computed from the $40\%$. An estimate is not a count.
\end{itemize}
...
\begin{enumerate}[leftmargin=1.3em, nosep, itemsep=3pt]
  ...
  \item Take the over-claim last, from Guided Practice (e): \emph{``Exactly $360$ Riverbend students have a part-time job.''} What word is wrong, and why (\emph{exactly} --- the $360$ is an estimate, and the true count is the parameter nobody knows).
\end{enumerate}
\columnbreak
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item \textbf{The estimate reported as a count} (GP~(b), GP~(e), HW~3): ``$360$
  ...
  \item \textbf{Over-claiming beyond the sample} (GP~(e), HW~6(c)): from $75$ on a Tuesday to
...
\textbf{This one document is the lesson --- pace it 20 / 14, then 10 for the debrief, then 10 for
...
\textbf{Do not skip Guided Practice part (e)} --- the report sentence and the over-claim. Without it students leave believing an estimate is a count, which is the version of this error that resurfaces in every
...
sample, the constraint --- on a school instead of a market. Part (c) is the crux transferred: $46\%$ against $40\%$, and a student who picks a survey has not left the hook vote. If you only get through (a), (b), (c), and (e), that is the right trade; (d) can be said aloud.
