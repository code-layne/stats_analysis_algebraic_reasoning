...
\wordbank{all 1,500 Harbor Point members \;\textbullet\; the 75 members asked on Tuesday evening \;\textbullet\; 75 \;\textbullet\; parameter \;\textbullet\; statistic \;\textbullet\; time \;\textbullet\; cost \;\textbullet\; access \;\textbullet\; destruction \;\textbullet\; change}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=5pt, topsep=2pt, start=3]
  ...
  \item Estimate how many of the pool's $1{,}500$ members mainly swim laps.
        ...
        Write that result as one sentence for the board: name the group, and call it an estimate.
        \par\ansline{36\% of the 75 members asked mainly swim laps, so if they represent the pool,}
\ansline{about 540 of Harbor Point's 1,500 members do --- an estimate, not a count.}
  ...
  \item Label each number \textbf{parameter} or \textbf{statistic}, and say who it describes.
        ...
        \toprule
        \textbf{The number} & \textbf{Kind?} & \textbf{Describes\dots} \\
        \midrule
        ...
        True mean visits per month, all $1{,}500$ members.
          & \ans{parameter} & \ans{all 1,500 members} \\
        Records: $62\%$ of all $1{,}500$ members renewed.
          & \ans{parameter} & \ans{all 1,500 members} \\
        \bottomrule
        \end{tabularx}
        \end{center}

  \item Name the constraint that keeps the board from surveying all $1{,}500$ members.
        ...
        \midrule
        Reaching every member in person would take staff three weeks.
          & \ans{time} \\
  ...
  \item A month later a different staff member asks another $75$ members the same question.
        This time $30$ say they mainly swim laps --- that is $30/75 = 40\%$. A board member
        says, ``One of you counted wrong.'' Explain why the difference between $36\%$ and
        $40\%$ does \emph{not} mean that, and say how many true percents there are for all
        $1{,}500$ members.
        \par\ansline{Two samples of 75 give two statistics --- sampling variability, not a counting error.}
\ansline{There is exactly one true percent for all 1,500 members; both surveys estimate it.}
...
whoever showed up on a Tuesday evening. Next class is about \emph{how} a sample gets chosen,
and why that choice decides what a statistic is worth.
\end{spiralbox}
