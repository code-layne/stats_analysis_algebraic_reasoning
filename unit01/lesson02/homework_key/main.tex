...
% Students START IT IN CLASS in the last eight minutes of the period, alone, while the
...
% Items 4-6 sit in the "continued" box so item 4's lead-in is never orphaned from its table.
...
\begin{remindbox}
\small
\textbf{This is your graded homework.} It is scored out of 12 and due at the start of next
class. You will start it in the last minutes of the period, so ask about anything that stalls
