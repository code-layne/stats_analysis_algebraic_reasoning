...
\ansline{about 540 of Harbor Point's 1,500 members do --- an estimate, not a count.}
  ...
  \item A month later a different staff member asks another $75$ members the same question.
        ...
        $1{,}500$ members.
        \par\ansline{Two honest samples give two statistics --- sampling variability, not an error.}
\ansline{There is exactly one true percent for all 1,500 members; both estimate it.}
