%! Principles of Experimental Design — Unit 1, Lesson 1.6 — Guided Notes & Practice (Answer Key)
...
\vtermans{Experiment}{A study in which the researcher assigns the units to groups and imposes a treatment on at least one group. The test: who built the groups?}
\vtermans{Control group}{The group that does not get the treatment. It is the baseline the treatment group is compared against --- not a wasted group.}
\vtermans{Random assignment}{Letting chance --- a generator, a coin, drawn slips --- decide which group each unit goes in, so the groups start out alike.}
\vtermans{Confounding variable}{A variable that differs between the groups and also affects the response, so the treatment and it cannot be told apart. 1.5's lurking variable, inside the experiment.}
\vtermans{Blinding}{Keeping the subjects (single-blind), or the subjects and the people measuring the response (double-blind), from knowing who is in which group.}
\end{vocabbox}
...
\par\ansline{Answers vary --- most pick this quarter's, many because ``the gap is bigger.''}
\ansline{(Settled at problem 12: this quarter's --- chance built the groups, not 20 beats 15.)}
\end{hookbox}
...
The $120$ are the \labelbox{2cm}{subjects}\quad attending is the \labelbox{2cm}{treatment}\quad the other $60$ are the \labelbox{2.4cm}{control}\par}
\\
& \notesprompt{Experiment or not? Say who decided which group each person was in.}
\begin{probgrid}{|Y|Y|}
\pcell{1}{Pull $150$ student records and compare the pass rate of students who used the Study Center to those who did not.}{1.2cm}{Not an experiment --- the students chose (Lesson 1.5).} & \pcell{2}{Ask for volunteers, then let a random number generator send $60$ to the Study Center and $60$ nowhere.}{1.2cm}{An experiment --- the generator decided the groups.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{3}{Survey a random sample of pool members about what time they swim and how well they sleep.}{1.2cm}{Not an experiment --- a survey; members chose.} & \pcell{4}{Give $60$ randomly chosen volunteers a new tutoring app and the other $60$ the old worksheet packet. \textbf{Vote first:} is there a control group?}{1.5cm}{An experiment. Yes --- the packet group is the control.} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{6}{One short phrase each: how does Riverbend's experiment meet comparison, randomization, replication, and control?}{1.5cm}{60 vs.\ 60; a generator split them; 60 per group; same classes.} & \pcell{7}{In Cedar Ridge's last plan the reminder group also got new bins. Name the confounding variable, and say why the manager cannot tell what caused the extra recycling.}{1.5cm}{The new bins --- the groups differ two ways, so either could explain it.} \\ \hline
\end{probgrid}
\\ \hline
...
Room B is a \labelbox{2cm}{placebo}\quad neither side knows: \labelbox{2.6cm}{double-blind}\par}
\\
& \notesprompt{Who knows, and who is in which block?}
\begin{probgrid}{|Y|Y|}
\pcell{8}{Students picked for the Study Center try harder simply \emph{because} they were picked. What is that called, and how does Room~B remove it?}{1.5cm}{The placebo effect. Room B is a placebo --- both groups now meet.} & \pcell{9}{Fill the blocking diagram: of the $80$ who passed everything, how many go to each group? Of the $40$ who did not? Why block instead of trusting chance?}{1.5cm}{80: 40 and 40; 40: 20 and 20; 60 per group. Blocking makes it certain.} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{4pt}
Last quarter may claim: \labelbox{2.6cm}{association}\qquad This quarter may claim: \labelbox{2.2cm}{caused}\par}
\\
& \textbf{In your own words:} why may this quarter say \emph{caused}?
\writespace{1.0cm}{Chance built the groups alike --- only the treatment is left to explain the gap.}
\\
& \notesprompt{Now settle the hook vote.}
\begin{probgrid}{|Y|Y|}
\pcell{10}{Last quarter's Study Center users were mostly students who were \emph{already struggling}. Where did the struggling volunteers end up this quarter --- and what does that do to the gap?}{1.3cm}{Chance spread them across both groups.} & \pcell{11}{Write this quarter's conclusion in one sentence for the counselor. Use the verb the design earns.}{1.3cm}{Attending \emph{caused} a higher pass rate: 75\% vs.\ 55\%.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{12}{\textbf{Vote again:} last quarter's \; this quarter's \; neither. Give the reason. A classmate says ``this quarter's, because $20$ points beats $15$.'' Is that the reason?}{1.4cm}{This quarter's --- chance built the groups. No: the design earns the verb.} & \pcell{13}{Suppose last quarter's \emph{watched} study had found $90\%$ vs.\ $55\%$ --- a $35$-point gap, bigger than the experiment's $20$. Would that be the study to believe? Explain.}{1.4cm}{No. A self-chosen gap is inflated by whoever chose; it earns only association.} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{14}{Name the experimental units, the treatment, and the control group. Who decided the slots?}{1.4cm}{The 90 volunteers; the 6 a.m.\ slot; the 45 at 7 p.m. Chance decided.} & \pcell{15}{What percent of each group averaged $7+$ hours? How many points apart?}{1.4cm}{$27/45 = 60\%$; $18/45 = 40\%$. \par $60 - 40 = 20$ points.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{16}{One phrase each: how does this design meet the four principles? Who can be blinded here?}{1.3cm}{Two slots, a generator, 45 each. The log scorers can be.} & \pcell{17}{Watching gave $25$ points; assigning gives $20$. Which is the stronger evidence, and why?}{1.3cm}{The 20 --- the 25 was inflated by retirement.} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}
