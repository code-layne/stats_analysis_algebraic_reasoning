...
\begin{enumerate}[leftmargin=1.6em, itemsep=9pt, topsep=3pt]
  ...
  \item Name the parts of this experiment.
        ...
        \par\vspace{4pt}
        Experimental units: \blank{4.2cm} \hfill Treatment: \blank{4.6cm}
        \par\vspace{8pt}
        Control group: \blank{4.6cm} \hfill Who decided the groups? \blank{3.4cm}
  ...
  \item Compute the reading rate for each group, then the gap.
        ...
        \textbf{(c)} The program group is higher by \blank{2cm} percentage points.
...
\begin{enumerate}[leftmargin=1.6em, itemsep=5pt, topsep=2pt, start=3]
  ...
  \item Of the $200$ volunteers, $120$ are adults and $80$ are children. The director blocks
        ...
        \midrule
        Adults   & $120$ & \blank{1.6cm} & \blank{1.6cm} \\
        Children & $80$  & \blank{1.6cm} & \blank{1.6cm} \\
        \bottomrule
        \end{tabularx}
        \end{center}
        \par\writeline
