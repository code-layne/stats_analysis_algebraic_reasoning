...
\begin{enumerate}[leftmargin=1.6em, itemsep=8pt, topsep=3pt]
  ...
  \item Compute the reading rate for each group.
        ...
        \textbf{(c)} The program group is higher by \ans{$30$} percentage
        points.
  ...
  \item Name the parts of this design.
        ...
        Experimental units: \ans{the $200$ volunteers} \hfill Treatment:
        \ans{the reading program}

        Control group: \ans{the $100$ on the list} \hfill Response variable:
        \ans{read $10+$ books or not}

  \item In a few words each, say how this design meets the four principles.

        Comparison: \ans{program group against waiting list} \hfill
        Randomization: \ans{a generator made the split}

        Replication: \ans{$100$ card holders in each group} \hfill
        Control: \ans{same card, same limits, same summer}

  \tcbbreak   % keep item 6's prompt with its table — mirrored in homework
  \item Each row is a different plan the director could have used instead. Name
        ...
        live far away wait. & \ans{control} \\
        \bottomrule
        \end{tabularx}
        \end{center}
  ...
  \item Of the $200$ volunteers, $120$ are adults and $80$ are children. The
        ...
        \midrule
        Total & $200$ & \ans{$100$} & \ans{$100$} \\
        \bottomrule
        \end{tabularx}
        \end{center}

        Why would the director block on age rather than leave it to chance?
        \ansline{Adults and children read differently; blocking guarantees an even split, chance only likely.}
  ...
  \item Last summer's study found a $48$-point gap; this summer's experiment
        ...
        \ansline{Last summer the sign-ups were already heavy readers, so part of the $48$ points was}
        \ansline{who they were. Chance built this year's groups, so all $30$ points belong to the program.}
