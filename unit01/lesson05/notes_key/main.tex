%! Observational Studies — Unit 1, Lesson 1.5 — Guided Notes & Practice (Answer Key)
...
\vtermans{Observational study}{A study in which you measure or survey a sample without trying to affect anyone. Nobody is assigned to a group --- the groups already exist. A survey is one type.}
\vtermans{Explanatory variable}{The variable we think might explain or account for the other one --- the tail of the arrow in the claim being tested.}
\vtermans{Response variable}{The variable we measure to see what happens --- the head of the arrow.}
\vtermans{Association}{Two variables move together: knowing which group an individual is in changes what you expect for the other variable. Not the same as causation.}
\vtermans{Lurking variable}{A variable outside the study that affects both variables in it, and can create an association all by itself.}
\end{vocabbox}
...
\par\ansline{Answers vary --- most say ``safe'': the sample was random and everyone answered.}
\ansline{(Settled at problem 13: not safe --- no bias, and still no causation.)}
\end{hookbox}
...
Left: \labelbox{2.2cm}{the members}\quad Right: \labelbox{2.2cm}{the director}\quad Observational: \labelbox{1.5cm}{WATCH}\par}
\\
& \notesprompt{Observational study or not? Say \emph{who decided the groups}.}
\begin{probgrid}{|Y|Y|}
\pcell{1}{Ask a random sample of members what time they usually swim and how much they sleep.}{1.1cm}{Yes --- the members chose when to swim.} & \pcell{2}{Count how many members walk in before $8$~a.m.\ every day for a week.}{1.1cm}{Yes --- watching only.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{3}{Assign half the members to swim at $6$~a.m.\ and half at $7$~p.m.\ for a month, then compare their sleep. \textbf{Vote first, then decide.}}{1.1cm}{No --- the director assigns the groups (an experiment, 1.6).} & \pcell{4}{Mail the sleep survey to \emph{every} member on the membership list (a census).}{1.1cm}{Yes --- a census is still observational.} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{5}{\textbf{Collect.} Who was on the frame, how was the sample chosen, and how many answered?}{1.2cm}{All $1{,}500$ members; random $200$; all answered.} & \pcell{6}{\textbf{Represent.} How will the $200$ answers be organized? Name the two things each member is sorted by.}{1.2cm}{Two-way table: swim time by sleep ($7$+ hrs or fewer).} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{7}{\textbf{Analyze \& communicate.} What do the numbers say, in context? Use your warm-up.}{1.2cm}{$70\%$ vs. $45\%$ get $7$+ hrs --- a $25$-point gap, morning higher.} & \pcell{8}{Nowhere in the plan does anybody tell a member when to swim. What does that one absence make the study?}{1.2cm}{Observational --- nobody assigned a swim time.} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{5pt}
Tail of the arrow: \labelbox{2.6cm}{explanatory}\qquad Head: \labelbox{2.6cm}{response}\par}
\\
& \notesprompt{Read the table. Keep the two denominators straight --- $80$ and $120$.}
\begin{probgrid}{|Y|Y|}
\pcell{9}{From your warm-up: the two percents, the gap in percentage points, and which group is higher.}{1.2cm}{$56/80 = 70\%$, $54/120 = 45\%$; gap $25$ points, morning higher.} & \pcell{10}{About how many of all $1{,}500$ members get at least $7$ hours? Show the pooled percent first.}{1.2cm}{$110/200 = 55\%$; $0.55 \times 1{,}500 = 825$ --- an estimate.} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{5pt}
Story 3's ``retired?'' is a \labelbox{3.6cm}{lurking variable}\par}
\\
...
\begin{probgrid}{|Y|Y|}
\pcell{11}{\textbf{Story 2.} Write the arrow backwards for \emph{this} table: how could sleep decide swim time, instead of the other way around?}{1.4cm}{People who sleep well can get up for a $6$ a.m.\ swim.} & \pcell{12}{\textbf{Story 3.} Percent retired in each group? Is \emph{retired} inside the table or outside it --- so what is it called?}{1.4cm}{$60/80 = 75\%$ vs. $18/120 = 15\%$. Outside --- a lurking variable.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{13}{\textbf{Vote again:} safe \; not safe. Which is supported --- \emph{``morning swimmers report more sleep''} or \emph{``swimming in the morning makes you sleep longer''}? Why only one?}{1.8cm}{Not safe. Only ``morning swimmers report more sleep'' is supported.} & \pcell{14}{\emph{``If the evening swimmers switched to mornings, they would sleep more.''} Supported? What kind of claim is a prediction about switching?}{1.8cm}{Not supported --- predicting a switch is a causal claim.} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{15}{Observational study? Who decided the groups? Name the explanatory and the response variable.}{1.4cm}{Yes. Explanatory: Center use. Response: passing.} & \pcell{16}{Compute both pass rates and the gap in percentage points. Which group is higher?}{1.4cm}{$39/60 = 65\%$, $72/90 = 80\%$; gap $15$ points --- non-users higher.} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{17}{Write the finding as an \emph{association} sentence: both percents, the gap, no causal verb. Does it support the memo?}{1.7cm}{$65\%$ of users passed vs. $80\%$ of non-users. Association only --- memo not supported.} & \pcell{18}{Last quarter, before the Center opened, $45$ of the $60$ users had already failed a class; $9$ of the $90$ non-users had. Percents? Which story --- and what settles it?}{1.7cm}{$45/60 = 75\%$ vs. $9/90 = 10\%$. Backwards. Assigning would settle it.} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}
