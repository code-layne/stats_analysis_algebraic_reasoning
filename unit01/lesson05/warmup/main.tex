...
\begin{enumerate}[leftmargin=1.8em, itemsep=22pt, topsep=10pt]
  ...
  \item Compare the two groups, then put the whole sample back together.
        ...
        \midrule
        How many \textbf{percentage points} higher is the morning group? & \blank{3cm} \\
        How many of the $200$ members in the sample said yes in total?  & \blank{3cm} \\
        What \textbf{percent of the whole sample} of $200$ said yes?     & \blank{3cm} \\
        \bottomrule
        \end{tabularx}
