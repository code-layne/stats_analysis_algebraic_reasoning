...
% beside a KNOWN parameter. Row 1 of the notes table opens on these numbers; the hook asks whether
...
\begin{enumerate}[leftmargin=1.8em, itemsep=22pt, topsep=10pt]
  ...
  \item The staff member uses her $36\%$ to describe the whole membership.
        ...
        Off by \blank{2.2cm} members \qquad The prediction is \blank{2.4cm}
