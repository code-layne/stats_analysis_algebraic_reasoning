...
Scatter around it: \labelbox{2.4cm}{}\qquad Same miss every time: \labelbox{1.3cm}{}\par}
\\
& \notesprompt{Read the display. \emph{Consistent is not the same as correct.}}
\begin{probgrid}{|Y|Y|}
\pcell{1}{Average each row: random ($19$, $22$, $19$) and Tuesday ($35$, $36$, $37$).}{1.0cm}{} & \pcell{2}{Both rows wobble. Which row misses the truth \emph{every} time --- too high or too low?}{1.0cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{3}{Tuesday evening is lap-swim time. Who is over-counted, and why does that push the number up?}{1.2cm}{} & \pcell{4}{The Tuesday row agrees with itself better. Is it the row to trust? Explain.}{1.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{3pt}
Off the frame: \labelbox{2.9cm}{}\quad Chosen but silent: \labelbox{2.4cm}{}\par}
...
\begin{probgrid}{|Y|Y|}
\pcell{5}{Ask the members who arrive on a Tuesday evening.}{1.0cm}{} & \pcell{6}{Email the survey only to members with an email address on file.}{1.0cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{7}{Post the survey on the pool's social media page.}{1.0cm}{} & \pcell{8}{Mail a card to \emph{all} $1{,}500$; $200$ mail it back. \textbf{Careful: the frame is perfect.}}{1.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\midrule
The lifeguard hands it out and waits; the staff is rated ``excellent.'' & \blank{3.1cm} \\
``No opinion'' on all fifteen questions. & \blank{3.1cm} \\
Agrees with every statement, even two that conflict. & \blank{3.1cm} \\
Titled \emph{``Help us show the pool needs longer hours.''} & \blank{3.1cm} \\
Crowding asked first: $62\%$ back a lane. Money first: $41\%$. & \blank{3.1cm} \\
\bottomrule
\end{tabularx}\small
\\
& \notesprompt{Say which way it pushes.}
\begin{probgrid}{|Y|Y|}
\pcell{10}{Same words, two orders: $62\%$ versus $41\%$. How many points apart --- and which order would a member who \emph{wants} the lane ask?}{1.0cm}{} & \pcell{11}{Choose the $75$ at random from the full list, but keep the title \emph{``Help us show the pool needs longer hours.''} Fixed? Explain.}{1.0cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{3pt}
The bracket shrinks: \labelbox{2.4cm}{}\qquad The gap stays: \labelbox{1.3cm}{}\par}
\\
...
\begin{probgrid}{|Y|Y|}
\pcell{12}{Compute $270$ of $750$ as a percent. Off by how many points from $20\%$? One Tuesday was off by how many?}{1.2cm}{} & \pcell{13}{\textbf{Vote again:} yes \; no \; it depends. Did $750$ land closer than $75$? What did ten times the work change --- and not change?}{1.4cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{14}{Name the bias each fix removes: (a) a complete list as the frame; (b) calling back the silent; (c) neutral, anonymous wording.}{1.2cm}{} & \pcell{15}{The board offers a random sample of just $75$ from the full list. Smaller than $750$ --- is it better? Why?}{1.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{16}{What share of the $600$ answered at all? What share of \emph{those} said parking is a problem? Scale that percent to all $600$.}{1.3cm}{} & \pcell{17}{Every household got a card. Could a silent one have been chosen --- so which bias? The census says $40\%$: off by how many points, how many households, which way?}{1.4cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{18}{Management mails again: $300$ back, $192$ complain --- $64\%$ again. Two-bedroom households own the most cars \emph{and} answer at twice the rate. Why did twice the cards not help?}{1.2cm}{} & \pcell{19}{The card asked: \emph{``Don't you agree that Cedar Ridge's parking lot is dangerously overcrowded?''} Name the response bias it invites, then rewrite it to push neither way.}{1.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}
