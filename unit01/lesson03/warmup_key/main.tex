%! Choosing a Sample: Four Sampling Techniques — Unit 1, Lesson 1.3 — Warm-Up (Answer Key)
...
% stratified allocation with the name removed — row 3 of the notes (problem 7) opens on this 18. Item 3
% is the systematic sample with the name removed — k = 900/60 = 15, start 7, then 22 and 37 —
% which row 2 of the notes (problem 6) picks up. Same 900 students the notes use.
