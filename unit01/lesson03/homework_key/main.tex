%! Choosing a Sample: Four Sampling Techniques — Unit 1, Lesson 1.3 — Homework (Answer Key)
...
\begin{enumerate}[leftmargin=1.6em, itemsep=9pt, topsep=3pt]
  ...
  \item The Tuesday-evening study.
        \par\vspace{4pt}
        Population: \ans{all 1,500 members} \hfill Sample: \ans{the 75 asked Tuesday evening}
        \par\vspace{8pt}
        It was a \ans{convenience} sample. Name one kind of member who had \emph{no chance} of
        being chosen by it.
        \par\ansline{Morning or weekend swimmers, or anyone who works Tuesday evenings.}
  ...
  \item \textbf{Plan A --- simple random sample.} You number the members $0001$ to $1500$
        ...
        1587 & \ans{no --- out of range (above 1500)} & \ans{none} \\
...
\begin{enumerate}[leftmargin=1.6em, itemsep=4pt, topsep=2pt, start=3]
  ...
  \item \textbf{Plan C --- systematic sample} from the numbered list. Find $k$; the random
        ...
        Next three: \ans{24} \qquad \ans{39} \qquad \ans{54}
  ...
  \item \textbf{Plan D --- cluster sample.} Draw $4$ of the $25$ swim sessions at random and
        ...
        \ans{stratified} and Plan D is \ans{cluster}. The four sessions drawn are three lap-swim hours
        and one fitness hour --- a random draw, every count correct. Explain why the results
        still might not describe all $1{,}500$ members.
        \par\ansline{A swim session is not a small mix of the membership --- lap swimmers fill lap hours --- so}
\ansline{four clusters that all lean one way leave families and seniors out. Chance chose; the groups are alike inside.}
  ...
  \item The board says: ``Whatever we do, seniors must be heard --- they pay dues too, and they
        ...
        \par\ansline{Plan B, stratified: it samples the senior stratum separately, so 25 seniors are guaranteed}
\ansline{a place in proportion. No other plan promises seniors appear at all --- a random draw only makes it likely.}
