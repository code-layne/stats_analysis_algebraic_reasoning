%! Comparing Studies and Choosing a Method — Unit 1, Lesson 1.7 — Guided Notes & Practice
...
\vterm{Controlled experiment}
\vterm{Observational study}
\vterm{Collection method}
\vterm{Observation}
\vterm{Content analysis}
\end{vocabbox}
...
Left: a(n) \labelbox{4.0cm}{}\qquad Right: a(n) \labelbox{2.6cm}{}\par}
\\
...
Does the researcher impose a treatment? & \blank{2.9cm} & \blank{2.9cm} \\
Are the groups alike before the study starts? & \blank{2.9cm} & \blank{2.9cm} \\
Strongest conclusion it earns & \blank{2.9cm} & \blank{2.9cm} \\
\bottomrule
\end{tabularx}\small
\\
& \notesprompt{Write the strongest sentence each Riverbend study earns --- the verb is the whole answer.}
\begin{probgrid}{|Y|Y|}
\pcell{2}{Watched: $65\%$ of the $60$ users passed, against $80\%$ of the $90$ non-users.}{1.5cm}{} & \pcell{3}{Assigned: $75\%$ of the $60$ treated passed, against $55\%$ of the $60$ control.}{1.5cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{4}{Last quarter the Study Center looked \emph{harmful}, this quarter \emph{helpful}. Which result should she believe, and what earns it that trust?}{1.6cm}{} & \pcell{5}{The warm-up's tell: one study's groups were $60$ and $90$, the other's $60$ and $60$. How do the sizes give away who built them?}{1.6cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{6}{Does a $10$-minute silent reading block raise reading scores?}{1.6cm}{} & \pcell{7}{Do students who smoke have worse lung function at age $30$?}{1.6cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{8}{Do students with bus rides over $45$ minutes score lower on the state test? A classmate says \emph{``unethical.''} Is that the reason?}{1.6cm}{} & \pcell{9}{The long riders \emph{do} score lower. May the report say the ride \emph{lowers} scores? Give the verb it may use, and why.}{1.6cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
The stage where an experiment's plan differs from 1.5's: \labelbox{2.0cm}{}\par}
\\
& \notesprompt{Plan the check-in experiment. Write the stage, not just its name.}
\begin{probgrid}{|Y|Y|}
\pcell{10}{\textbf{Collect.} Name the units, say what the generator does, and name the two groups.}{2.0cm}{} & \pcell{11}{\textbf{Analyze \& report.} What two numbers do you compare, and which verb may the report use? Why that verb?}{2.0cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{12}{The library wants five years of borrowing records summarized.}{1.2cm}{} & \pcell{13}{Why did four students stop coming to the Study Center? Name the method, and why a written survey is a poor fit.}{1.5cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{14}{Does the cafeteria's fruit actually get \emph{taken} --- not just reported taken?}{1.2cm}{} & \pcell{15}{\textbf{Vote again:} agree \; disagree. She sat and watched who came. Name the \emph{method} and the \emph{design}. Does watching make it an observational study?}{1.9cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{16}{Label the two earlier studies by design, and say who built the groups in each.}{1.7cm}{} & \pcell{17}{Compute the two rates in the water-aerobics study and the gap, then write the strongest sentence it earns.}{1.9cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{18}{Next question: \emph{do members who already have arthritis sleep worse?} Can she assign it? Which reason? What does she run, with which verb?}{2.0cm}{} & \pcell{19}{She measured the pain by asking all $120$ the same three questions; she also wants to know \emph{why} some quit. Name both methods --- does either change the design?}{2.0cm}{} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}
