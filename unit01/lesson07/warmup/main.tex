...
\begin{enumerate}[leftmargin=1.8em, itemsep=22pt, topsep=10pt]
  ...
  \item Put the two studies side by side.
        ...
        \midrule
        Last quarter --- watched $150$ records  & \blank{2.2cm} & \blank{2.2cm} \\
        This quarter --- assigned $120$ volunteers & \blank{2.2cm} & \blank{2.2cm} \\
        \bottomrule
        \end{tabularx}

        \vspace{10pt}
        Who put each student in a group \emph{last} quarter? \blank{5cm}
