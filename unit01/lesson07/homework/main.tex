...
\begin{enumerate}[leftmargin=1.6em, itemsep=7pt, topsep=2pt]
  ...
  \item Sort the two earlier studies by design.
        ...
        \par\vspace{3pt}
        Last summer's: \blank{3.6cm} \hfill This summer's: \blank{3.6cm}
        \par\vspace{6pt}
        Who decided which group each card holder was in \emph{last} summer? \blank{5.2cm}
  ...
  \item Compute the book-club rates, then find the gap.
        ...
        The club group is higher by \blank{2cm} percentage points. Write the strongest
...
\begin{enumerate}[leftmargin=1.6em, itemsep=5pt, topsep=2pt, start=3]
  ...
  \item Fill in the plan the director followed for the book-club study.
        ...
        Collect & \blank{9.1cm} \\
        Represent & \blank{9.1cm} \\
        Analyze \& report & \blank{9.1cm} \\
        \bottomrule
        \end{tabularx}
  ...
  \item The board sends two more questions. For each, decide whether the director could
        ...
        \midrule
        Does a $\$5$ late fee reduce overdue books? & \blank{1.1cm} & \blank{3.2cm} \\
        Do children read to as toddlers read more at $12$? & \blank{1.1cm} & \blank{3.2cm} \\
        \bottomrule
        \end{tabularx}
  ...
  \item Name the collection method that fits each job best.
        ...
        \midrule
        Which titles were borrowed most over the past five years & \blank{3.8cm} \\
        How many of the $1{,}200$ card holders want Sunday hours & \blank{3.8cm} \\
        Why one long-time member stopped coming in, in her own words & \blank{3.8cm} \\
        How many visitors actually use the new self-checkout machine & \blank{3.8cm} \\
        Six teens talking together about what the teen room needs & \blank{3.8cm} \\
        \bottomrule
        \end{tabularx}
