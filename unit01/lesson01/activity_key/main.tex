...
\begin{enumerate}[leftmargin=1.6em, itemsep=6pt, topsep=4pt]
  ...
  \item What was the \textbf{variable of interest} --- what did the manager
        ...
        Variable: \ans{what the student bought} \hfill Type: \ans{categorical}
  ...
  \item The manager drafts two questions for a second study.
        ...
        \ansline{A says nothing about what is measured. ``How many mornings per week do Riverbend}
        \ansline{students buy breakfast at school?''}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=6pt, topsep=4pt, start=5]
  ...
  \item The manager runs the second study and surveys $80$ Riverbend students. Of
        ...
        \ansline{Of the 80 Riverbend students surveyed, 30\% would buy breakfast every morning ---}
        \ansline{about 270 of Riverbend's 900 students.}
  ...
  \item Each report below fails at one stage of the cycle. Write the stage number
        ...
        ``Riverbend students love the cart.''
          & \ans{2} & \ans{only cart users were asked} \\
        The manager wrote down all 40 answers as a paragraph and never counted
        them by item.
          & \ans{3} & \ans{never organized, so nothing is readable} \\
        \bottomrule
        \end{tabularx}
        \end{center}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=5pt, topsep=2pt]
  ...
  \item The school newspaper prints: \textit{``$35\%$ of Riverbend students buy a bagel
        ...
        \ansline{(1) Only the 40 students who left the cart were asked, not all Riverbend students.}
  ...
  \item Two groups ask about the same students. Group 1 records \emph{how many mornings
        ...
        \ansline{Group 1 asked for a count of mornings; Group 2 asked for a yes/no label.}
