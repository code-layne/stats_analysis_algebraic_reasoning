%! The Statistical Cycle and Types of Data — Unit 1, Lesson 1.1 — Guided Notes & Practice
...
\vterm{Data cycle}
\vterm{Statistical question}
\vterm{Variable of interest}
...
The stage that names the group a conclusion may describe: \labelbox{2.6cm}{}\par}
\\
& \notesprompt{Here is what the council did last spring, out of order. Give the stage number, and say what that stage handed on.}
\begin{probgrid}{|Y|Y|}
\pcell{1}{Asked $60$ students how they usually get to school.}{1.2cm}{} & \pcell{2}{Told the district what the survey showed.}{1.2cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{3}{Decided to ask how Riverbend students travel to school.}{1.2cm}{} & \pcell{4}{Counted the $60$ answers into a table by travel method.}{1.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{4pt}
For this question the variable of interest is \labelbox{4.2cm}{}\par}
\\
& \notesprompt{Which test does each question fail? Repair it --- keep the original subject and put back only what was missing.}
\begin{probgrid}{|Y|Y|}
\pcell{5}{``How do I get to school?''}{1.4cm}{} & \pcell{6}{``Do people like biking?''}{1.4cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{7}{``Is the breakfast cart good?''}{1.4cm}{} & \pcell{8}{``How many minutes is a Riverbend student's trip to school?'' \textbf{Test it before you touch it.}}{1.4cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
Bike & $6$  & \blank{4.2cm} \\
\midrule
\textbf{Total} & \blank{1.2cm} & \blank{4.2cm} \\
\bottomrule
\end{tabularx}\small
\\
& \notesprompt{Read the table --- then move to stage 4.}
\begin{probgrid}{|Y|Y|}
\pcell{10}{Add the four percents. What must they total? Which group is smallest --- and could you see that in the $60$ raw answers?}{1.6cm}{} & \pcell{11}{Riverbend has $900$ students. Scale the bike percent to the school, then write the council's \textbf{conclusion in context}: the group asked, the number, what was measured.}{1.8cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\end{tikzpicture}\par\vspace{4pt}
Same students, two types. What decided the type? \labelbox{2.6cm}{}\par}
\\
...
\begin{probgrid}{|Y|Y|}
\pcell{12}{``How old are the bikes Riverbend students ride to school?'' Nothing is collected yet. What gets recorded, what type, summarized how?}{1.4cm}{} & \pcell{13}{``How do Riverbend students usually get to school?'' Why is a \emph{mean travel method} impossible --- and what does the table give instead?}{1.4cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{14}{\textbf{Vote again:} yes \; no \; can't tell. The council's arithmetic is right: $6$ of $60$ is $10\%$, about $90$ of $900$. Does the survey show students \emph{would} bike if there were racks? Which stage did the problem enter at?}{1.8cm}{} & \pcell{15}{Of $40$ students leaving the breakfast cart, $14$ bought a bagel --- $35\%$, correctly. The newspaper prints: \emph{``$35\%$ of Riverbend students buy a bagel every morning.''} Which stage did that enter at? Name \emph{two} claims the data cannot support.}{1.8cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{16}{Name the variable of interest and its type --- \emph{before} looking at the $80$ answers. How do you know?}{1.2cm}{} & \pcell{17}{What percent of the students asked said yes? If they are typical of the school, about how many of the $900$ is that?}{1.2cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{18}{Write the conclusion the council can hand to the district. Name the group asked, the number, and what was measured.}{1.6cm}{} & \pcell{19}{Suppose the $80$ had all been standing at the bike rack. Which stage would the problem have entered at --- and what could the report no longer claim?}{1.6cm}{} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}
