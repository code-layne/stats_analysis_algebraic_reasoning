...
\midrule
Asked $60$ students how they usually get to school.  & \blank{1.2cm} \\
Told the district what the survey showed.            & \blank{1.2cm} \\
Decided to ask how Riverbend students travel.        & \blank{1.2cm} \\
Counted the answers into a table by travel method.   & \blank{1.2cm} \\
\bottomrule
\end{tabularx}
\end{center}
\end{notesbox}
...
Is the breakfast cart good?      & \blank{1cm} & \blank{6cm} \\
\bottomrule
\end{tabularx}
\end{center}
...
count --- \blank{2.6cm}. Ask the same $30$ students whether they \emph{ever} eat
breakfast at school and you record yes or no --- \blank{2.6cm}. The
...
on hand can answer it. So they go back to stage \blank{1.2cm} and run the cycle
again.
\end{notesbox}
...
Variable: \blank{6.4cm} \hfill Type: \blank{3cm}
...
did the problem enter at? \blank{2cm}
