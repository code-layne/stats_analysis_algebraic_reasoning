%! Unit Launch: Inference for Means — Unit 8, Lesson 8.0 — Lesson Plan
...
\newcommand{\UnitNumberName}{Unit 8: Inference for Means and Course Capstone \quad}
\newcommand{\LessonNumberName}{Lesson 8.0: Unit Launch: Inference for Means}
